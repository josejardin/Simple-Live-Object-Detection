...
classes = ["background", "aeroplane", "bicycle", "bird", "boat",
           "television", "bus", "car", "cat", "chair", "cow", "bed",
           "dog", "horse", "motorbike", "person", "bed", "sheep",
           "cellphone", "train", "bottle"]
...
while True:
    ...
    blob = cv2.dnn.blobFromImage(cv2.resize(image, (300, 300)), 0.010, (300, 300), 130)
